  ...
  return (
    ...
    >
      <div className="px-fluid mx-auto w-full py-12">
        <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-12 lg:gap-6">
          {/* Brand / tagline / CTA */}
          <div className="lg:col-span-5">
            <div className="flex flex-col items-center lg:items-start">
              ...
              />
              <p className="mx-auto mt-4 max-w-md text-center text-sm leading-relaxed text-neutral-400 lg:mx-0 lg:text-left">
                {TAGLINE}
              </p>
              <Link
                href="/about"
                className="group mt-6 inline-flex items-center justify-center gap-2 rounded-lg bg-neutral-800 px-6 py-2.5 text-sm font-medium text-neutral-400 transition-all duration-300 hover:bg-neutral-700 hover:text-white"
              >
                About Us
              </Link>
            </div>
                ...
                <div className="mt-4 flex items-center justify-center gap-3 sm:justify-start">
                  {SOCIALS.map(({ label, href, Icon, iconClass }) => (
                    <a
                      ...
                      aria-label={label}
                      className="group flex h-10 w-10 items-center justify-center rounded-lg bg-neutral-800 text-neutral-400 transition-all duration-300 hover:bg-neutral-700 hover:text-white"
                    >
                      <Icon
                        className={cn(
                          iconClass,
