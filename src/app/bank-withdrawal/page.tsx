...
export default function BankWithdrawalPage() {
  return (
    <div className="w-full px-fluid py-10">
      <h1 className="font-heading text-2xl font-bold tracking-tight text-white sm:text-3xl">Bank Withdrawal</h1>
      <p className="mt-2 text-sm text-white/55">Complete your withdrawal with a direct bank transfer.</p>
